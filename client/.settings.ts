...
export const ASCII_SETTING_SELECT = {
  ...
  asciiText: 'generate-ascii-text',
  asciiHtml: 'generate-ascii-html',
  heading: `Select between classic ascii which can also be used in terminals or colored ascii that uses HTML`,
  optionPlaceholder: 'Select ascii type...',
  pixelWidthPlaceholder: 'Pixel Width',
  pixelHeightPlaceholder: 'Pixel Height',
  colorModePlaceholder: 'Select color mode',
